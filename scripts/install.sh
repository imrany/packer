...
echo ""
echo "To uninstall, run '${BINARY_NAME} uninstall'"
echo "Or run 'curl -fsSL https://raw.githubusercontent.com/imrany/packer/main/scripts/uninstall.sh | sh' to uninstall."
